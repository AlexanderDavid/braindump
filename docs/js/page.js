      ...
      element.addEventListener("click", function (e) {
        if (!e.ctrlKey && !e.metaKey) {
          ...
          if (!element.href.includes("/ox-hugo/")) {
            newlinks = Array.prototype.slice.call(page.querySelectorAll("a"));
            newlinks.forEach(function (innerElement) {
              console.log(innerElement.classList);
              innerElement.classList.remove("linked");
              console.log(innerElement.classList);
            });
