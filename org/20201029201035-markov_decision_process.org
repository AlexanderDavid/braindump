...
:PROPERTIES:
:ID:       bd69a4e9-bac2-48f5-892c-cbdaf1d78294
:END:
** Stochasticity
...
- The agent receives rewards at each step and a big reward if it exits at +1 and a bad reward if it exits at -1
  [[file:images/2020-09-03_17-54-54_screenshot.png]]
** Stochastic motion model
[[file:images/2020-09-03_17-58-54_screenshot.png]]
...
[[file:images/2020-09-03_18-02-27_screenshot.png]]
...
- MDPs are non-deterministic search problems
    [[file:images/2020-09-03_18-05-59_screenshot.png]]
- In a MDP, "Markov" means that the action outcomes depend only on the current state
    [[file:images/2020-09-03_18-07-52_screenshot.png]]
...
- MDP quantities so far
  ...
  + Utility $U_\pi=\Sigma^H_{t=0}\gamma^tR(s_t)$ Sum of discounte d rewards
** Solving MDPs
*** Value Iteration
 + $\pi^*=\text{argmax}_\pi \mathbb{E} [\Sigma^H_{t=0}\gamma^tR(s_t) | \pi]$
**** Optimal value Function $V^*$
- $V^*(s)$ is the sum of discounted rewards starting in $s$ and acting optimally
[[file:images/2020-09-08_17-31-58_screenshot.png]]

#+DOWNLOADED: screenshot @ 2020-09-08 17:34:27
[[file:images/2020-09-08_17-34-27_screenshot.png]]

- Closed form for $V^*$ is CV$V^*=max_a(R(s, a, s') + \gamma V^*(s'))$
 #+DOWNLOADED: screenshot @ 2020-09-08 17:40:23
 [[file:images/2020-09-08_17-40-23_screenshot.png]]
**** Bellman Equation
$V^*(s) = max_a \mathbb{E} [R(s, a, s') + \gamma V^*(s')]$
**** Q-Values
- $Q^*(s, a)$ = expected utility starting at state $s$, taking action $a$, and then acting optimally
 #+DOWNLOADED: screenshot @ 2020-09-08 18:06:00
 [[file:images/2020-09-08_18-06-00_screenshot.png]]
*** Policy Iteration
